...
PARSING_SCRIPT = "/home/rodrigo/01_repos/GWAS_pipeline/utils/summary-gwas-imputation/src/gwas_parsing.py"
SPRED_EXEC = "/home/rodrigo/doctorado/software/MetaXcan/software/SPrediXcan.py"
VARIANT_METADATA = "/home/rodrigo/01_repos/GWAS_pipeline/data/gtex_v8_eur_filtered_maf0.01_monoallelic_variants.txt.gz"
...
def main(config, args):
    ...
    config.gwas_folder = "/home/rodrigo/01_repos/GWAS_pipeline/output/coma/finetuned_mlruns" # /GWAS_1223dbdba9314a0e8427a519ff524ef9_z000.tsv
    ...
    gwas_ifile = os.path.join(config.gwas_folder, gwas_file(phenotype))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', "-c", type=str, default="config_postprocessing_gtex_v7.yaml")
